...
\begin{enumerate}
	...
	\item {\bf jueves 21 (marzo)}:
	\item {\bf lunes 25 (marzo)}:
	\item {\bf jueves 28 (marzo)}:
	\item {\bf lunes 1 (abril)}:
	\item {\bf jueves 4 (abril)}:
	\item {\bf lunes 8 (abril)}:
	\item[] {\bf jueves 11 (abril)}: {\bf Clases canceladas (profesor en Bologna, por conferencia).}
	\item[] {\bf lunes 15 (abril)}: {\bf Clases canceladas (profesor en Bologna, por conferencia).}
	\item[] {\bf jueves 18 (abril)}: {\bf Clases canceladas (feriado religioso).}
	\item {\bf lunes 22 (abril)}:
	\item[] {\bf jueves 25 (abril)}: {\bf Clases canceladas (profesor en Concepci\'on, por conferencia).}
	\item {\bf lunes 29 (abril)}:
	\item[] {\bf jueves 2 (mayo)}: {\bf Clases canceladas (sandwich, d\'ia del trabajador).}
	\item {\bf lunes 6 (mayo)}:
	\item {\bf jueves 9 (mayo)}:
	\item[] {\bf lunes 13 (mayo)}: {\bf Clases canceladas (profesor en New Orleans, por conferencia).}
	\item[] {\bf jueves 16 (mayo)}: {\bf Clases canceladas (profesor en New Orleans, por conferencia).}
	\item {\bf lunes 20 (mayo)}: 
	\item {\bf jueves 23 (mayo)}:
	\item {\bf lunes 27 (mayo)}:
