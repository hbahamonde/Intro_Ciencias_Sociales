...
\begin{enumerate}
	...
	\\
	\\
	El/la ayudante y yo asumiremos durante todo el semestre que has le\'ido. Nosotros empleamos un m\'etodo de clases interactivo, pero este m\'etodo necesita de tu participaci\'on activa en clases. \emph{Asistencia no s\'olo significa que vayas a clase; debes participar}. Esto significa que aunque hayas ido a todas las clases, es \emph{imposible} que tengas la nota m\'axima en asistencia si es que no has participado en clases y ayudant\'ia. 
\\
\\	
	Para asegurarnos de que est\'es haciendo las lecturas, habr\'an una serie de \emph{pop quizzes} (``pruebas sorpresa'') tanto en c\'atedra como ayudant\'ia. Estos controles ser\'an cortos (3-5 minutos), y apuntan a medir si leyeron; o sabes, o no. Estas pruebas se aplicar\'an completamente al azar, en cualquier momento de la clase, y sin previo aviso. Si faltaste, tendr\'as un 1 en ese control. 
	...
	\item {\bf Tres pruebas t\'ematicas}: {\input{/Users/hectorbahamonde/RU/Teaching/Intro_Ciencias_Sociales/percentage_prueba_seccion.txt}\unskip}\% cada una.
		...
		\begin{itemize}
			\item[-] Econom\'ia: {\input{/Users/hectorbahamonde/RU/Teaching/Intro_Ciencias_Sociales/date_seccion_economia.txt}\unskip}.
			\item[-] Pol\'itica: {\input{/Users/hectorbahamonde/RU/Teaching/Intro_Ciencias_Sociales/date_seccion_politica.txt}\unskip}.
			\item[-] Sociedad: {\input{/Users/hectorbahamonde/RU/Teaching/Intro_Ciencias_Sociales/date_seccion_sociedad.txt}\unskip}.
		\end{itemize}
...
% Reaction Papers
	...
	\\ 
	\\
	En este ejercicio, escribir\'as seis ``papers de reacci\'on'' de dos p\'aginas como m\'aximo---papers m\'as largos, no ser\'an corregidos mas all\'a del limite establecido. Esencialmente, el/la ayudante queremos saber \emph{qu\'e piensas t\'u de la lectura}. {\bf No queremos res\'umenes}: los res\'umenes ser\'an calificados con un 1. Espec\'ificamente, queremos saber: 

	\begin{itemize}
		\item[-] Qu\'e te llam\'o' la atenci\'on? Alg\'un hallazgo/pa\'is/situaci\'on/hecho que t\'u conozcas, pero que no calce con la teor\'ia del/la autor/a?
		\item[-] Qu\'e hubieras hecho diferente, si t\'u hubieras sido el/la autor/a?
		\item[-] Se habr\'a olvidado de algo el/la autor/a?
	\end{itemize}

	Si te fijas bien, para esta actividad no hay fecha. T\'u manejas tus tiempos. Lo que queremos es que escojas los libros que m\'as te llamen la atenci\'on, y el dia donde discutamos ese libro, tu entregues un reaction paper al comienzo de la clase. 
\\
\\
	Presta atenci\'on a las siguientes instrucciones:

	\begin{itemize}
		\item[-] Debes presentar dos \emph{reaction papers} por secci\'on. Esto es, dos \emph{reaction papers} para la secci\'on de econom\'ia, dos \emph{reaction papers} para la secci\'on de pol\'itica, y dos \emph{reaction papers} para la secci\'on de sociedad.
		\item[-] Los \emph{papers} se entregan {\bf impresos} y {\bf dentro de los primeros 15 minutos de clase}. Desde el minuto 16 en adelante no se recibir\'an \emph{papers}. \emph{Papers} entregados v\'ia \emph{email} no ser\'an aceptados bajo ninguna circunstancia.
		\item[-] Si lees el libro X, el \emph{reaction paper} se entrega el d\'ia en el cual esta designada esa lectura. No en otro d\'ia.
		\item[-] No habr\'an \emph{reaction papers} acerca de documentales.
		\item[-] Organ\'izate bien: t\'u decides cu\'ando entregar un \emph{reaction paper}. Sin embargo, cada \emph{reaction paper} que te falte ser\'a calificado con un 1.
	\end{itemize}
...
En este curso, la actividad final es un ensayo ``take-home'' de 10-15 p\'aginas. En base a un temario que se entregar\'a el {\input{/Users/hectorbahamonde/RU/Teaching/Intro_Ciencias_Sociales/date_temario.txt}\unskip}, tendr\'as que escribir un ensayo cr\'itico de las lecturas, seguramente integrando varias secciones. {\color{red}En su debido momento, conversaremos los pormenores del ensayo (formato, bibligraf\'ia externa, citas, etc.)}. 
	...
	\\
	\\
	Les recomiendo verme en \href{https://calendly.com/bahamonde/officehours}{mis office hours} \emph{antes} del plazo de entrega. Si quieres, \href{mailto:\filetext}{env\'iame un email} con tu borrador, y yo te devolver\'e comentarios. V\'elo como una pre-correcci\'on. Esto es voluntario. Tambi\'en puedes contactar a la TA. 

	\begin{itemize}
		\item[\Pointinghand] El ayudante y yo hemos escrito \href{https://github.com/hbahamonde/Intro_Ciencias_Sociales/raw/master/Ensayo_Final/Bahamonde_Ensayo_Checklist.pdf}{un documento} que contiene un \emph{checklist} del ensayo final.
	\end{itemize}
