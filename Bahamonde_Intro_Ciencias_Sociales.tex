...
\texttt{e:}\href{mailto:mariela.soto@pregrado.uoh.cl}{\texttt{mariela.soto@pregrado.uoh.cl}}\\
...
Este {\color{blue}curso de pregrado} ofrece una introducci\'on a los conceptos y tem\'aticas---y sobre todo, al lenguaje---que nosotros, los cientistas sociales, usamos a diario. El curso est\'a dise\~nado tanto para estudiantes de Administraci\'on P\'ublica como Ingenier\'ia Comercial (ambas menciones). 
\\
\\
...
% Reaction Papers
	...
	\\ 
	\\
	En este ejercicio, escribir\'as seis ``\emph{papers} de reacci\'on'' de dos p\'aginas como m\'aximo---{\emph{papers}} m\'as largos, no ser\'an corregidos mas all\'a del limite establecido. Ya aprenderemos lo que es un \emph{paper} de reacci\'on. Esencialmente, el/la ayudante y yo, queremos saber \emph{qu\'e piensas t\'u de la lectura}. {\bf No queremos res\'umenes}: los res\'umenes ser\'an calificados con un 1. Espec\'ificamente, queremos saber: 
...
\\
    ...
    \item[$\bullet$] No se puede entregar m\'as de un \emph{reaction paper} por clase.
...
\item {\bf Econom\'ia}
	...
	\begin{itemize}
		...
		\item[] {\bf jueves 25 (abril)}: Documental en clases: ``\emph{Saving Capitalism}.'' Este d\'ia se puede comer. % Netflix.
		...
		\item {\bf lunes 6 (mayo)}: Anthony Atkinson. 2016. \emph{Desigualdad. ¿Qu\'e podemos hacer?} Fondo de Cultura Ec\'onomica: Introducci\'on, Cap. 1 y Cap. 2.\footnote{Los respectivos TAs entregaran las fotocopias a los respectivos delegados de curso. Cada curso se organizar\'a de la mejor manera para que cada estudiante tenga las fotocopias.}\phantom{\textcite{Atkinson:2016aa}}

		\vspace{0.2cm}

		\item {\bf jueves 9 (mayo)}: Anthony Atkinson. 2016. \emph{Desigualdad. ¿Qu\'e podemos hacer?} Fondo de Cultura Ec\'onomica: Cap. 3.\footnote{Los respectivos TAs entregaran las fotocopias a los respectivos delegados de curso. Cada curso se organizar\'a de la mejor manera para que cada estudiante tenga las fotocopias.}\phantom{\textcite{Atkinson:2016aa}}
...
\item {\bf Pol\'itica}
	...
	\begin{itemize}
		...
		\item {\bf jueves 23 (mayo)}: Francis Fukuyama. 2016. \href{https://github.com/hbahamonde/Intro_Ciencias_Sociales/raw/master/Readings/Fukuyama.pdf}{\emph{Los Or\'igenes del Orden Pol\'itico: Desde la Prehistoria Hasta la Revoluci\'on Francesa}}. Deusto: Caps. 2, 3, 5.\phantom{\textcite{Fukuyama:2016aa}}

		\vspace{0.2cm}

		\item {\bf lunes 27 (mayo)}: Francis Fukuyama. 2016. \href{https://github.com/hbahamonde/Intro_Ciencias_Sociales/raw/master/Readings/Fukuyama.pdf}{\emph{Los Or\'igenes del Orden Pol\'itico: Desde la Prehistoria Hasta la Revoluci\'on Francesa}}. Deusto: Caps. 17 y 21.\phantom{\textcite{Fukuyama:2016aa}}

		\vspace{0.2cm}

		\item {\bf jueves 30 (mayo)}: Francis Fukuyama. 2016. \href{https://github.com/hbahamonde/Intro_Ciencias_Sociales/raw/master/Readings/Fukuyama.pdf}{\emph{Los Or\'igenes del Orden Pol\'itico: Desde la Prehistoria Hasta la Revoluci\'on Francesa}}. Deusto: Caps. 22 y 27.\phantom{\textcite{Fukuyama:2016aa}}
    ...
    \vspace{0.2cm}
		...
		\item {\bf jueves 20 (junio)}: Steven Levitsky y Daniel Ziblatt. 2018. \href{https://github.com/hbahamonde/Intro_Ciencias_Sociales/raw/master/Readings/Como_Mueren_Democracias.pdf}{\emph{C\'omo Mueren las Democracias}}. Ariel: Introducci\'on, Cap. 1 y Cap. 2.\footnote{Alternativamente, los respectivos TAs entregaran las fotocopias a los respectivos delegados de curso. Cada curso se organizar\'a de la mejor manera para que cada estudiante tenga las fotocopias.}\phantom{\textcite{Levitsky:2018ab}}

    \vspace{0.2cm}


		\item {\bf lunes 24 (junio)}: Steven Levitsky y Daniel Ziblatt. 2018. \href{https://github.com/hbahamonde/Intro_Ciencias_Sociales/raw/master/Readings/Como_Mueren_Democracias.pdf}{\emph{C\'omo Mueren las Democracias}}. Ariel: Cap. 3 y Cap. 4.\footnote{Alternativamente, los respectivos TAs entregaran las fotocopias a los respectivos delegados de curso. Cada curso se organizar\'a de la mejor manera para que cada estudiante tenga las fotocopias.}\phantom{\textcite{Levitsky:2018ab}}

    \vspace{0.2cm}

    \item {\bf jueves 27 (junio)}: Steven Levitsky y Daniel Ziblatt. 2018. \href{https://github.com/hbahamonde/Intro_Ciencias_Sociales/raw/master/Readings/Como_Mueren_Democracias.pdf}{\emph{C\'omo Mueren las Democracias}}. Ariel: Cap. 5.\footnote{Alternativamente, los respectivos TAs entregaran las fotocopias a los respectivos delegados de curso. Cada curso se organizar\'a de la mejor manera para que cada estudiante tenga las fotocopias.}\phantom{\textcite{Levitsky:2018ab}}
...
\begin{itemize}
    ...
    \vspace{0.2cm}
		...
		\item {\bf lunes 8 (julio)}: Jared Diamond. 2012. \href{https://github.com/hbahamonde/Intro_Ciencias_Sociales/raw/master/Readings/Diamond_Colapso_sociedades_perduran_desaparecen.epub}{\emph{Colapso: Por qu\'e unas Sociedades Perduran y otras Desaparecen}}. Debate Editorial: Cap 5 y Cap. 14.\footnote{Para este texto, debes tener un {\color{blue}\texttt{ePub}} reader. Consulta con los ayudantes d\'onde/c\'omo obtener uno.}\phantom{\textcite{Diamond:2012aa}}

    %\vspace{0.2cm}

		%\item {\bf jueves 11 (julio)}: Jared Diamond. 2012. \href{https://github.com/hbahamonde/Intro_Ciencias_Sociales/raw/master/Readings/Diamond_Colapso_sociedades_perduran_desaparecen.epub}{\emph{Colapso: Por qu\'e unas Sociedades Perduran y otras Desaparecen}}. Debate Editorial: Cap 10 y Cap. 14.\footnote{Para este texto, debes tener un {\color{blue}\texttt{ePub}} reader. Consulta con los ayudantes d\'onde/c\'omo obtener uno.}\phantom{\textcite{Diamond:2012aa}}

		%\item {\bf lunes 15 (julio)}: Naomi Klein. 2007. \href{https://github.com/hbahamonde/Intro_Ciencias_Sociales/raw/master/Readings/Shock_Klein.pdf}{\emph{La Doctrina del Shock. El auge del capitalismo del desastre}}. Paidos: Introduccion, Cap. 6, Cap. 7 y Cap. 8.\phantom{\textcite{Klein:2007aa}}

    \vspace{0.4cm}

		\item[\Pointinghand]  {\bf jueves 11 (julio)}: {\bf \underline{Ensayo en clases}} sobre textos de la secci\'on ``Sociedad''. No entran contenidos de otras secciones.
...
\begin{itemize}
    \item {\bf viernes 12 de julio 9 AM: Entrega del temario para el ``take home essay''.}
		\item[\Pointinghand]  {\bf domingo 14 julio 11:59 PM}: {\bf \underline{``Take Home Essay''}}: entrega via uCampus. {\bf\color{blue}Entra toda la materia.}
\end{itemize}
...
1) en el funturo dar Piketty: Intro, 9, 10, 11, 15.
