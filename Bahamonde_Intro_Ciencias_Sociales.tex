...
\item {\bf Pol\'itica}
	...
	\begin{itemize}
		...
		\item {\bf lunes 20 (mayo)}: Larry Bartels. 2008. \emph{Unequal Democracy: The Political Economy of the New Gilded Age}. Princeton University Press: Cap. 1 y Cap. 2. {\color{red}pending.}\phantom{\textcite{Bartels:2008aa}}

		\vspace{0.2cm}

		\item {\bf jueves 23 (mayo)}: Larry Bartels. 2008. \emph{Unequal Democracy: The Political Economy of the New Gilded Age}. Princeton University Press: Cap. 4. {\color{red}pending.}\phantom{\textcite{Bartels:2008aa}}

		\vspace{0.2cm}

		\item {\bf lunes 27 (mayo)}: Larry Bartels. 2008. \emph{Unequal Democracy: The Political Economy of the New Gilded Age}. Princeton University Press: Cap. 9 y Cap. 10. {\color{red}pending.}\phantom{\textcite{Bartels:2008aa}}

		\vspace{0.2cm}

		\item {\bf jueves 30 (mayo)}:
		\item {\bf lunes 3 (junio)}:
		\item {\bf jueves 6 (junio)}:
		\item {\bf lunes 10 (junio)}:
		\item {\bf jueves 13 (junio)}:
		\item {\bf lunes 17 (junio)}:
		\item {\bf jueves 20 (junio)}:
		\item {\bf lunes 24 (junio)}:
		\item {\bf jueves 27 (junio)}:
		\item {\bf lunes 1 (julio)}:
		\item {\bf jueves 4 (julio)}:
		\item {\bf lunes 8 (julio)}:
		\item {\bf jueves 11 (julio)}:
		\item {\bf lunes 15 (julio)}:
		\item {\bf jueves 18 (julio)}:
	\end{itemize}
...
\item {\bf Econom\'ia}
      ...
      \begin{itemize}
        ...
        \item[$\bullet$] Anthony Atkinson. 2015. \emph{Inequality: What Can Be Done?} Harvard University Press. {\color{red}pending.}\phantom{\textcite{Atkinson:2015aa}}
      \end{itemize}
...
\item {\bf Pol\'itica}
      ...
      \begin{itemize}
      	\item[$\bullet$] Larry Bartels. 2008. \emph{Unequal Democracy: The Political Economy of the New Gilded Age}. Princeton University Press. {\color{red}pending.}\phantom{\textcite{Bartels:2008aa}}
...
\item {\bf Sociedad}
      ...
      \begin{itemize}
        ...
        \item[$\bullet$] Naomi Klein. 2007. \href{https://github.com/hbahamonde/Intro_Ciencias_Sociales/raw/master/Readings/La_doctrina_del_Shock_Klein.pdf}{\emph{La Doctrina del Shock. El auge del capitalismo del desastre}}. Paidos.\phantom{\textcite{Klein:2007aa}}
      \end{itemize}
