...
\item {\bf Pol\'itica}
    ...
    \vspace{0.2cm}
		...
		\item {\bf jueves 20 (junio)}: Steven Levitsky y Daniel Ziblatt. 2018. \emph{C\'omo Mueren las Democracias}. Ariel: Introducci\'on, Cap. 1 y Cap. 2.\footnote{Los respectivos TAs entregaran las fotocopias a los respectivos delegados de curso. Cada curso se organizar\'a de la mejor manera para que cada estudiante tenga las fotocopias.}\phantom{\textcite{Levitsky:2018ab}}

    \vspace{0.2cm}


		\item {\bf lunes 24 (junio)}: Steven Levitsky y Daniel Ziblatt. 2018. \emph{C\'omo Mueren las Democracias}. Ariel: Cap. 3 y Cap. 4.\footnote{Los respectivos TAs entregaran las fotocopias a los respectivos delegados de curso. Cada curso se organizar\'a de la mejor manera para que cada estudiante tenga las fotocopias.}\phantom{\textcite{Levitsky:2018ab}}

    \vspace{0.2cm}

    \item {\bf jueves 27 (junio)}: Steven Levitsky y Daniel Ziblatt. 2018. \emph{C\'omo Mueren las Democracias}. Ariel: Cap. 5.\footnote{Los respectivos TAs entregaran las fotocopias a los respectivos delegados de curso. Cada curso se organizar\'a de la mejor manera para que cada estudiante tenga las fotocopias.}\phantom{\textcite{Levitsky:2018ab}}
